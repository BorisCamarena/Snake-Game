...
from juego1 import ViboritaInteligente, Direccion, Punto
...
# Definimos el tamaño de la cola ( T_cola ).
BATCH_SIZE = 1000
LR = 0.001
...
class Agente:
    ...
    # Modelo - red nueronal.
    # Optimizador. En Optimizar se ve algo curioso en el gradiente.
    ...
    def __init__(self):
        ...
        # Se crea un pila con el popleft().
    ...
    def ob_estado(self, juego):
        # definimos la cabeza de la viborita.
        head = juego.snake[0]
...
def entrenar():
    ...
    while True:
        ...
        if done:
            ...
            print('Juego', agent.n_games, 'Score', score, 'Record:', record)
